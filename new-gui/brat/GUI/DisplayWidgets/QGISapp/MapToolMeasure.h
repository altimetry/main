...
#ifndef VIEWS_QGISAPP_QGSMEASURETOOL_H
#define VIEWS_QGISAPP_QGSMEASURETOOL_H
...
class CMeasureTool : public QgsMapTool
{
...
public:
	...
	CMeasureTool( QgsMapCanvas* canvas, bool measureArea );
...
#endif		//VIEWS_QGISAPP_QGSMEASURETOOL_H
