...
CMeasureTool::CMeasureTool( QgsMapCanvas* canvas, bool measureArea )
	: QgsMapTool( canvas )
	, mWrongProjectProjection( false )
{
	...
	mDialog = new CMeasureDialog( this, Qt::WindowStaysOnTopHint );
...
const QList<QgsPoint>& CMeasureTool::points()
{
	return mPoints;
}


void CMeasureTool::activate()
{
	mDialog->show();
	QgsMapTool::activate();
...
void CMeasureTool::deactivate()
{
	mDialog->hide();
	QgsMapTool::deactivate();
}

void CMeasureTool::restart()
{
	mPoints.clear();
...
void CMeasureTool::updateSettings()
{
	QSettings settings;
...
void CMeasureTool::keyPressEvent( QKeyEvent* e )
{
...
void CMeasureTool::addPoint( QgsPoint &point )
{
...
QgsPoint CMeasureTool::snapPoint( const QPoint& p )
{
...
#include "moc_MapToolMeasure.cpp"
