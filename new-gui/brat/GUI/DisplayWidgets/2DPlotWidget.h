...
public:
	...
	void SetLineCurves()
	{
        ...
        void EnableTargetCurveStyleLine(int index)
        {
        ...
        void DisableTargetCurveStyleLine(int index)
        {
            CGeneralizedCurve * pcurve = this->mCurves[index];
            QwtSymbol c_symbol = pcurve->symbol();
        ...
        void SetTargetCurveStyleLine(int index)
        {
            ...
            c_symbol.setStyle(QwtSymbol::NoSymbol);
        ...
        void SetTargetCurvePenColor(int index,QColor new_color)
        {
            CGeneralizedCurve * pcurve = this->mCurves[index];
            ...
            old_color.setGreen(new_color.green());
            old_color.setRed(new_color.red());
            old_color.setBlue(new_color.blue());
        ...
        void SetTargetCurvePenAlpha(int index,int new_alpha)
        {
            CGeneralizedCurve * pcurve = this->mCurves[index];
        ...
        void SetTargetCurvePenWidth(int index, int pixels)
        {
            CGeneralizedCurve * pcurve = this->mCurves[index];
        ...
        void SetTargetCurvePointSymbol(int index, int val_symbol)
        {
            ...
            c_symbol.setStyle((QwtSymbol::Style)(val_symbol));
