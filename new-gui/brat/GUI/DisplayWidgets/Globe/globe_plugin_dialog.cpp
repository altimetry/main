...
//constructor
QgsGlobePluginDialog::QgsGlobePluginDialog( QWidget* parent, CGlobePlugin* globe, Qt::WindowFlags fl )
    : QDialog( parent, fl )
    , mGlobe( globe )
{
  setupUi( this );
...
{
  osgViewer::Viewer* viewer = mGlobe->mOsgViewer;
  if ( viewer )
  {
...
#include "moc_globe_plugin_dialog.cpp"
