...
#define DEFINE_FIELD_DATA_ENTRY( entry ) \
	const std::string entry = #entry;


DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_NAME )
DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DESC_NAME )
DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_TITLE )

DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_OPACITY )

DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_X_MAX )
DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_Y_MAX )
DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_X_MIN )
DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_Y_MIN )

DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_X_NUM_TICKS )
DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_Y_NUM_TICKS )
DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_Z_NUM_TICKS )

DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_X_NUM_DIGITS )
DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_Y_NUM_DIGITS )
DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_Z_NUM_DIGITS )

DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_X_LABEL )
DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_Y_LABEL )

DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_X_LOG )
DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_Y_LOG )

DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_COLOR_LABELS )
DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_WITHCONTOUR )
DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_NUMCONTOUR )
DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_CONTOURLINEWIDTH )
DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_CONTOURLINECOLOR )
DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_MIN_CONTOURVALUE )
DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_MAX_CONTOURVALUE )

DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_WITHSOLIDCOLOR )

DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_SHOW_LINES )
DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_SHOW_POINTS )

DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_POINTSIZE )
DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_GLYPHTYPE )
DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_FILLEDPOINT )

DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_LINE_COLOR )
DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_LINE_WIDTH )
DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_STIPPLE_PATTERN )
DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_POINT_COLOR )

DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_MIN_HEIGHT_VALUE )
DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_MAX_HEIGHT_VALUE )
DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_MIN_CURRENT_HEIGHT_VALUE )
DEFINE_FIELD_DATA_ENTRY( ENTRY_FIELD_DATA_MAX_CURRENT_HEIGHT_VALUE )
