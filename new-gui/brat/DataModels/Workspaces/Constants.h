...
const std::string ENTRY_DATA_MODE_DI_TIME_FIELD_NAME = "DataMode_di_time_field_name";
const std::string ENTRY_DATA_MODE_DI_DATE_TIME = "DataMode_di_date_time";
const std::string ENTRY_DATA_MODE_DI_DISTANCE_WEIGHTING = "DataMode_di_distance_waiting";
const std::string ENTRY_DATA_MODE_DI_TIME_WEIGHTING = "DataMode_di_time_waiting";
...
const std::string ENTRY_EXPORT_NETCDF_OUTPUT = "ExportNetcdfOutput";
...
DEFINE_DISPLAY_DATA_ENTRY( ENTRY_DISPLAY_X_NUM_TICKS )
DEFINE_DISPLAY_DATA_ENTRY( ENTRY_DISPLAY_Y_NUM_TICKS )
DEFINE_DISPLAY_DATA_ENTRY( ENTRY_DISPLAY_Z_NUM_TICKS )

DEFINE_DISPLAY_DATA_ENTRY( ENTRY_DISPLAY_DATA_Z_NUM_DIGITS )

DEFINE_DISPLAY_DATA_ENTRY( ENTRY_DISPLAY_X_NUM_DIGITS )
DEFINE_DISPLAY_DATA_ENTRY( ENTRY_DISPLAY_Y_NUM_DIGITS )
DEFINE_DISPLAY_DATA_ENTRY( ENTRY_DISPLAY_Z_NUM_DIGITS )

DEFINE_DISPLAY_DATA_ENTRY( ENTRY_DISPLAY_X_LABEL )
DEFINE_DISPLAY_DATA_ENTRY( ENTRY_DISPLAY_Y_LABEL )
DEFINE_DISPLAY_DATA_ENTRY( ENTRY_DISPLAY_Z_LABEL )
