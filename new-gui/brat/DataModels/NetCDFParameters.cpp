...
bool DisplayFilesProcessor::GetParametersNetcdfYFX( CExternalFilesNetCDF* externalFile )
{
	...
	if ( nFields == 0 )
	{
		...
		{
			std::string msg = CTools::Format( "DisplayFilesProcessor::GetParametersNetcdfYFX - No field with one dimension to display has been found in file '%s'",
	...
	{
		std::string msg = CTools::Format( "DisplayFilesProcessor::GetParametersNetcdfYFX : Array of field '%s' is 0 dimensional - It have to be at least 1 or 2 dimensional",
			m_paramXAxis.c_str() );
		CException e( msg, BRATHL_INCONSISTENCY_ERROR );
		throw ( e );
	...
	{
		std::string msg = CTools::Format( "DisplayFilesProcessor::GetParametersNetcdfYFX : Array of field '%s' is more than 2 dimensional - It have to be 1 or 2 dimensional",
			m_paramXAxis.c_str() );
		CException e( msg, BRATHL_INCONSISTENCY_ERROR );
		throw ( e );
	}
...
bool DisplayFilesProcessor::GetParametersNetcdfZFXY( CExternalFilesNetCDF* externalFile )
{
	...
	if ( nFields == 0 )
	{
		...
		if ( m_paramVars.size() <= 0 )
		{
			std::string msg = CTools::Format( "DisplayFilesProcessor::GetParametersNetcdfZFXY - No field with at least one dimension to display has been found in file '%s'",
				externalFile->GetName().c_str() );
			CException e( msg, BRATHL_INCONSISTENCY_ERROR );
			CTrace::Tracer( "%s", e.what() );
			throw ( e );
	...
	{
		std::string msg = CTools::Format( "DisplayFilesProcessor::GetParametersNetcdfZFXY : Array of field '%s' is not 1 dimensional.",
	...
	for ( itParamVar = m_paramVars.begin(); itParamVar != m_paramVars.end(); itParamVar++ )
	{
		...
		if ( dimValues.size() != 2 )
		{
			std::string msg = CTools::Format( "DisplayFilesProcessor::GetParametersNetcdfZFXY : Array of field '%s' is not 2 dimensional.",
				( *itParamVar ).c_str() );
			CException e( msg, BRATHL_INCONSISTENCY_ERROR );
			throw ( e );
		}
...
bool DisplayFilesProcessor::GetParametersNetcdfZFLatLon( CExternalFilesNetCDF* externalFile )
{
	...
	if ( fieldLat == NULL )
	{
		std::string msg = CTools::Format( "DisplayFilesProcessor::GetParametersNetcdfZFLatLon - No Latitude field has been found in file '%s'",
			externalFile->GetName().c_str() );
		CException e( msg, BRATHL_INCONSISTENCY_ERROR );
		CTrace::Tracer( "%s", e.what() );
		throw ( e );
	...
	if ( fieldLon == NULL )
	{
		std::string msg = CTools::Format( "DisplayFilesProcessor::GetParametersNetcdfZFLatLon - No Longitude field has been found in file '%s'",
			externalFile->GetName().c_str() );
		CException e( msg, BRATHL_INCONSISTENCY_ERROR );
		CTrace::Tracer( "%s", e.what() );
		throw ( e );
	...
	if ( nFields == 0 )
	{
		...
		if ( m_paramVars.size() <= 0 )
		{
			std::string msg = CTools::Format( "DisplayFilesProcessor::GetParametersNetcdfZFLatLon - No field with at least one dimension to display has been found in file '%s'",
				externalFile->GetName().c_str() );
			CException e( msg, BRATHL_INCONSISTENCY_ERROR );
			CTrace::Tracer( "%s", e.what() );
			throw ( e );
	...
	{
		std::string msg = CTools::Format( "DisplayFilesProcessor::GetParametersNetcdfZFLatLon : Array of field '%s' is not 1 dimensional",
...
bool DisplayFilesProcessor::GetParametersNetcdf()
{
	bool bOk = false;
