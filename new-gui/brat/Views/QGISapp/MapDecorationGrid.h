 ...
 *                                                                         *
 ***************************************************************************/
#ifndef VIEWS_QGISAPP_QGSDECORATIONGRID_H
#define VIEWS_QGISAPP_QGSDECORATIONGRID_H
...
class CDecorationGrid : public CDecorationItem
{
...
public:
	//! Constructor
	CDecorationGrid( QgsMapCanvas *parent );
	//! Destructor
	virtual ~ CDecorationGrid();
...
protected:
	const QgsMapCanvas& canvas() const
	{
		return *mMap;
	}
...
#endif		//		VIEWS_QGISAPP_QGSDECORATIONGRID_H
