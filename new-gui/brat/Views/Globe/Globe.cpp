...
//constructor
GlobePlugin::GlobePlugin( QgisInterface* theQgisInterface, QgsMapCanvas *theCanvas, QWidget *dialogParent )		//theCanvas = nullptr, QWidget *dialogParent = nullptr
	: mCanvas( theCanvas )
	, mOsgViewer( 0 )
	, mRootNode( 0 )
	, mMapNode( 0 )
	...
	, mSelectedElevation( 0. )
{
	...
	mSettingsDialog = new QgsGlobePluginDialog( dialogParent, this, QgisGui::ModalDialogFlags );
