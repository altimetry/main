...
//		- are defined through calls to CSchedulerLogger::Instance().LogMsg
//
...
public:
	static CSchedulerLogger& Instance();
...
#define LOG_INFO( msg ) log_info< CSchedulerLogger >( msg )
#define LOG_WARN( msg ) log_warn< CSchedulerLogger >( msg )
#define LOG_FATAL( msg ) log_fatal< CSchedulerLogger >( msg )
