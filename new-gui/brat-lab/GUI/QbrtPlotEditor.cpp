...
enum Plot3dExample
{
	e_Simple_SurfacePlot, e_Plot3dExample_first = e_Simple_SurfacePlot,
	e_Autoswitching_axes,
	e_Vertex_Enrichment,
...
void QbrtPlotEditor::Autoswitching_axes()
{
...
void QbrtPlotEditor::Simple_SurfacePlot()
{
...
void QbrtPlotEditor::setupUi()
{
	...
	label->setText( QApplication::translate( "", "<html><head><meta name=\"qrichtext\" content=\"1\" /></head><body style=\" white-space: pre-wrap; font-family:MS Shell Dlg; font-weight:400; font-style:normal; text-decoration:none;\"><p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Level</p></body></html>", 0, QApplication::UnicodeUTF8 ) );
	label_2->setText( QApplication::translate( "", "<html><head><meta name=\"qrichtext\" content=\"1\" /></head><body style=\" white-space: pre-wrap; font-family:MS Shell Dlg; font-weight:400; font-style:normal; text-decoration:none;\"><p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Width</p></body></html>", 0, QApplication::UnicodeUTF8 ) );

	QMetaObject::connectSlotsByName( this );
} // setupUi


void QbrtPlotEditor::Vertex_Enrichment()
{
...
void QbrtPlotEditor::setLevel( int i )
{
	level_ = 1 - i / 100.;
...
void QbrtPlotEditor::setWidth( int i )
{
	width_ = i / 20000.;
	bar->configure( width_, level_ );
	mPlots[0]->updateData();
