...
class PyAlgoExampleAnother(PyBratAlgoBase):
    ...
    #----------------------------------#
    #   Used by PyAlgoExampleAnother.Run()   #
    #----------------------------------#
    ...
    def Dump(self):
        fOut = ""
        fOut += ("\n==> Dump a PyAlgoExampleAnother Object at " + str(hex(id(self))) + 
                 "\n")
        ...
        fOut += ("==> END Dump a PyAlgoExampleAnother Object at " + str(hex(id(self)))
                 + "\n")
        print (fOut)
