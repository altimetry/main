/*
 * $Id: utlib.c,v 1.22 2004/12/02 17:10:43 steve Exp $
 *
...
/* cfortran.h replaced by dummy definitions in order to disable fortran interface */
#define DOUBLE_PRECISION double
#define FCALLSCSUB0(X1,X2,X3)
#define FCALLSCSUB1(X1,X2,X3,X4)
#define FCALLSCSUB2(X1,X2,X3,X4,X5)
#define FCALLSCSUB3(X1,X2,X3,X4,X5,X6)
#define FCALLSCFUN0(X1,X2,X3,X4)
#define FCALLSCFUN1(X1,X2,X3,X4,X5)
#define FCALLSCFUN2(X1,X2,X3,X4,X5,X6)
#define FCALLSCFUN3(X1,X2,X3,X4,X5,X6,X7)
#define FCALLSCFUN4(X1,X2,X3,X4,X5,X6,X7,X8)
#define FCALLSCFUN5(X1,X2,X3,X4,X5,X6,X7,X8,X9)
#define FCALLSCFUN6(X1,X2,X3,X4,X5,X6,X7,X8,X9,X10)
#define FCALLSCFUN7(X1,X2,X3,X4,X5,X6,X7,X8,X9,X10,X11)
#define FCALLSCFUN8(X1,X2,X3,X4,X5,X6,X7,X8,X9,X10,X11,X12)
/* end of replacement */
#include "udunits.h"
#include "utscan.h"
#include "utprivate.h"
