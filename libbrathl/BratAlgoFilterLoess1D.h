...
public:
  ...
  virtual string GetName() { return "BratAlgoFilterLoessAtp"; };
  
  virtual string GetDescription() { return "Loess filter (smoothing filter) for one-dimensional data (e.g. along-track data) as input data source. "
