...
namespace brathl
{
	...
	{
		mLabel = "Ers Radar Altimeter Waveform product";
	...
	//----------------------------------------
	CProductErsWAP::CProductErsWAP( const CStringList &fileNameList, bool check_only_first_file )
		: CProductErs( fileNameList, check_only_first_file )
