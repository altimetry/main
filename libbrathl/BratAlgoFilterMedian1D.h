...
public:
  ...
  virtual string GetName() { return "BratAlgoFilterMedianAtp"; };
  
  virtual string GetDescription() { return "Median filter for one-dimensional data (e.g. along-track data) as input data source. "
