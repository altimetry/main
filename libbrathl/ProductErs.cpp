...
namespace brathl
{
	...
	//----------------------------------------
	CProductErs::CProductErs( const CStringList &fileNameList, bool check_only_first_file )
	...
	//----------------------------------------
	void CProductErs::InitDateRef()
	{
		m_refDate = REF19900101;
	}
	...
	//----------------------------------------
	bool CProductErs::IsHighResolutionField( CField* field )
	{
		if ( field == NULL )
		{
			return false;
