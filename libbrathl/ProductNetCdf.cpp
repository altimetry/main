...
namespace brathl
{
	...
	*/
	...
	//----------------------------------------
	CProductNetCdf::CProductNetCdf( const CStringList& fileNameList, bool check_only_first_files )
		: CProduct( fileNameList, check_only_first_files )
	{
		Init();
	}
...
//#define TEST_ApplyCriteriaLatLon
	...
	*/
	...
	bool CProductNetCdf::Open()
	{
		...
		m_externalFile = dynamic_cast<CExternalFilesNetCDF*>( BuildExistingExternalFileKind( m_currFileName ) );
		if ( m_externalFile == NULL )
		{
