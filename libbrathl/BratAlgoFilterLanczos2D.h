...
public:
  ...
  virtual string GetName() { return "BratAlgoFilterLanczosGrid"; };

  virtual string GetDescription() { return "Lanczos filter for two-dimensional data (e.g. gridded data) as input data source. "
