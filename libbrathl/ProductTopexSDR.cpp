...
namespace brathl
{
	...
	{
		mLabel = "SDR Topex/Poseidon pass file";
	...
	//----------------------------------------
	CProductTopexSDR::CProductTopexSDR( const CStringList &fileNameList, bool check_only_first_file )
		: CProductTopex( fileNameList, check_only_first_file )
	...
	//----------------------------------------
	const std::string& CProductTopexSDR::GetLabel() const
	{
		return mLabel;
	}
