...
//----------------------------------------------------------------------------
void vtkGeoGridSource::PrintSelf(std::ostream& os, vtkIndent indent)
{
    this->Superclass::PrintSelf(os, indent);

    os << indent << "Longitude Graticule: " << this->LongGraticule << std::endl;
    os << indent << "Latitude Graticule: " << this->LatGraticule << std::endl;
    os << indent << "Point distance: " << this->PointDistance << std::endl;
    os << indent << "Create parallels for poles: "
    << this->CreateParallelsForPoles << std::endl;

    os << indent << "Outputxx: " << std::endl;
    vtkPolyData *output = (vtkPolyData *)this->GetOutput();
    output->Print(os);
    os << indent << "Pointsxx: " << std::endl;
    /*
    vtkPoints* points = output->GetPoints();
    points->Print(os);
    os << indent << "Datasxx: " << std::endl;
