...
//----------------------------------------------------------------------------
void vtkGeoMapFilter::PrintSelf(std::ostream& os, vtkIndent indent)
{
  this->Superclass::PrintSelf(os, indent);

  os << indent << "OffsetLatitude : " << this->OffsetLatitude << std::endl;
  os << indent << "OffsetLongitude : " << this->OffsetLongitude << std::endl;
  os << indent << "MinMappedValue : " << this->MinMappedValue << std::endl;
  os << indent << "MaxMappedValue : " << this->MaxMappedValue << std::endl;
  os << indent << "Factor : " << this->Factor << std::endl;
  os << indent << "Radius : " << this->Radius << std::endl;
  os << indent << "MapWidth : " << this->MapWidth << std::endl;
  os << indent << "MapHeight : " << this->MapHeight << std::endl;
}
